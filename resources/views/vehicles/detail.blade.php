...
<nav class="navbar navbar-expand-lg navbar-custom px-4">
    <a class="navbar-brand fw-bold" href="/vehicles">Rental <span>Kendaraan</span></a>
                            ...
                            @foreach($vehicle->images as $img)
                                <div class="thumb-card">
                                    ...
                                    <div class="thumb-action">
                                        ...
                                        @else
                                            <form action="/vehicles/image/set-primary/{{ $img->id }}" method="POST">
                                                @csrf
...
<script>
    function setAsMainImage(imageSrc, button) {
        ...
        const thumb = button.parentElement.querySelector('.thumbnail-image');
        if (thumb) {
